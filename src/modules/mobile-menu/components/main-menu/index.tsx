              ...
              <Link href="/store">
                <a>
                  <button
                    ...
                    onClick={close}
                  >
                    <span className="sr-only">Ir para Loja</span>
                    <span>Loja</span>
                      ...
                      <a>
                        ...
                        >
                          <span className="sr-only">
                            Ir para coleção {collection.title}
                          </span>
        ...
        <div className="flex flex-col">
          <div className="flex flex-col gap-y-8 text-small-regular">
            {!customer ? (
              ...
              <div className="flex flex-col gap-y-4">
                <span className="text-gray-700 uppercase">Logado como</span>
            ...
            <div className="flex flex-col gap-y-4">
              ...
              <button
                ...
                onClick={setScreenCountry}
              >
                <span className="sr-only">Selecione pais de entrega</span>
